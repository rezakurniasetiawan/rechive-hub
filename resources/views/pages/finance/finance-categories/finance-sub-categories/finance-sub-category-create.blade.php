<div class="intro-y flex items-center mt-8">
    ...
    <h2 class="text-lg font-medium mr-auto">
        Create New Sub Finance Category
    </h2>
</div>
...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 lg:col-span-6">
        ...
        <div class="intro-y box p-5">
            <form action="{{ route('finance.category.sub.store', $category->id) }}" method="POST">
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="name" class="input w-full border mt-2"
                        placeholder="e.g., Operational, Savings, Personal Expense" required>
                </div>
