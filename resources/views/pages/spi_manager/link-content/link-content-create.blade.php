...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 lg:col-span-6">
        ...
        <div class="intro-y box p-5">
            <form action="{{ route('spi.content.store') }}" method="POST">
                @csrf

                <!-- Video URL Field -->
                <div class="mt-3">
                    <label class="font-medium">Video URL <span class="text-red-600 ml-1" aria-hidden="true">*</span>
                        <span class="sr-only">required</span></label>
                    <input type="url" name="video_url" class="input w-full border mt-2"
                        placeholder="e.g., https://www.youtube.com/..." required>
                </div>
